...
function drawText() {
  ...
  if (frameNumber > 600 && frameNumber < 900) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["Nuvvu lekunda,", "nitho matladakunda undalenu"],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
  ...
  if (frameNumber > 1200 && frameNumber < 1500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "I just want to spend my entire life with you",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 1800 && frameNumber < 2100) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "Whatever the situation comes, I will always hold your hand as a family",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "nuvvu ane person vi na life lo lekapothe",
          "I would definitely feel alone",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
      ...
      context.fillText(
        "nuvvu ane person vi na life lo lekapothe I would definitely feel alone",
        canvas.width / 2,
        canvas.height / 2
      );
    }
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          ...
          "Thanks for bringing colours into my life",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
      ...
      context.fillText(
        "I love you so much Nanna Thanks for bringing colours into my life",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber >= 3300 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "Na life motham nitho spend cheyali ani undi",
          "You are my world ankiluu",
        ],
        canvas.width / 2,
        canvas.height / 2 + 70,
        fontSize,
      ...
      context.fillText(
        "Na life motham nitho spend cheyali ani undi You are my world ankiluu",
        canvas.width / 2,
        canvas.height / 2 + 50
      );
    }
